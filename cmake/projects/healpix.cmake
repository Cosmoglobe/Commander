  ...
  ## Avoid warning about DOWNLOAD_EXTRACT_TIMESTAMP
	...
	if(CMAKE_Fortran_COMPILER_ID MATCHES Intel)
		#set(healpix_sharp2_C_FLAGS "-static-intel -O3 -ffast-math -march=native -std=c99 -DUSE_MPI -qopenmp -D__PURE_INTEL_C99_HEADERS__")
		    ...
		    set(healpix_sharp2_C_FLAGS "-static-intel -O3 -fp-speculation=safe -march=native -std=c99 -DUSE_MPI -qopenmp -D__PURE_INTEL_C99_HEADERS__")
                elseif(CMAKE_BUILD_TYPE MATCHES Debug)
                    set(healpix_sharp2_C_FLAGS "-static-intel -O0 -g -fp-speculation=safe -march=native -std=c99 -DUSE_MPI -qopenmp -D__PURE_INTEL_C99_HEADERS__")
                endif()
