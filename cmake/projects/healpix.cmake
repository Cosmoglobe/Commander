...
if(COMPILE_HEALPIX)
  ...
  ## Avoid warning about DOWNLOAD_EXTRACT_TIMESTAMP
    ...
    set(healpix_sharp2_C_FLAGS "-static-intel -g -O2 -fp-model=fast -fp-speculation=fast -march=native -std=c99 -DUSE_MPI -qopenmp -D__PURE_INTEL_C99_HEADERS__")
    #set(healpix_sharp2_C_FLAGS "-static-intel -O3 -fp-model=fast -march=native -std=c99 -DUSE_MPI -qopenmp -D__PURE_INTEL_C99_HEADERS__")
