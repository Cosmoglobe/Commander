...
def test_plot():
    ...
    plt.plot(grt_times[f'{side}_{current}_{grt}'][inds], grts[f'{side}_{current}_{grt}'][inds])
    ...
    plt.plot(grt_times[f'{side}_{current}_{grt}'][inds], grts[f'{side}_{current}_{grt}'][inds], 'o')
