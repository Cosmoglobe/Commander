function FEX_SCILIM_st, Nstruct
 
  common FEX_SCILIM_st, defined
  ...
  if N_elements( defined ) NE 1 then begin
       ...
       lim = { LIM                       , $
               ...
               COLLECT_TIME:collect_time , $
               ATTITUDE:attitude         , $
               GLITCH_RATE: fltarr( 4 )      }
 
       fex_scilim = { FEX_SCILIM                , $
                      CT_HEAD:ct_head           , $
                      LIM: replicate( lim, 2 )  , $
                      LIM_SPARES: bytarr( 160 )     }
...
return, replicate( {FEX_SCILIM}, Nstruct )
end
