	integer * 4 function  fsl_temporal_drift (spec_time, ticald,
     .						  primary_vib)

c-------------------------------------------------------------------------------
c
c	Function FSL_TEMPORAL_DRIFT
c
...
c       Modified FCF_Temporal_Drift to FSL_Temporal_Drift for the new FIRAS 
c       pipeline which will process long spectra to get improved frequency 
c       resolution. Changed status, include file, and function names.
c
c-------------------------------------------------------------------------------

	implicit none
...
c
	...
	fsl_temporal_drift = %loc(fsl_normal)
