      integer*4 function fic_shape_check(channel,scan_mode,cth,num_recs,
...
c
c     Author: R. Isaacman, ARC, 2/3/86
c
...
c     Modifications:
c
c     J. Durachta, 9/19/86: Error messages added; error trapping altered.
c    
c     J. Durachta, 10/16/87: Check for minimum number of ifgs moved to end of 
c     instrument state consistency check.
c
...
c     Input parameters.
c
      integer*4 channel,scan_mode,num_recs
...
c
      ...
      fic_shape_check = %loc(fic_normal)
c
