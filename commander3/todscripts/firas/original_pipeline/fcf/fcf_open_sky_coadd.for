	integer * 4 function  fcf_open_sky_coadd (ct_lun)

c-------------------------------------------------------------------------------
c
c	Function FCF_OPEN_SKY_COADD
c
...
C
	   ...
	   query_cat.filename   = 'FIC_SKY_' // fac_channel_ids(fcc_chan)
...
C
	   ...
	   query_ttg.dataset_name  = 'FIC_SKY_' // fac_channel_ids(fcc_chan)
     .						// fac_scan_mode_ids(smode)
...
c
	   fcc_infile = 'CSDR$FIRAS_IN:FIC_SKY_' // fac_channel_ids(fcc_chan)
     .						 // fac_scan_mode_ids(smode)
     .						 // '.' // fcc_file_ext
...
c
	   fcc_temp_outfile_vs = 'CSDR$FIRAS_OUT:FCF_VSK_' // fcc_scan_mode //
     .				 '_TMP.' // fcc_file_ext
	   fcc_temp_outfile_ds = 'CSDR$FIRAS_OUT:FCF_DSK_' // fcc_scan_mode //
     .				 '_TMP.' // fcc_file_ext
	   fcc_temp_outfile_cs = 'CSDR$FIRAS_OUT:FCF_SKY_' // fcc_scan_mode //
     .				 '_TMP.' // fcc_file_ext
	   fcc_outfile_vs = 'CSDR$FIRAS_OUT:FCF_VSK_' // fcc_scan_mode // '.' //
     .			     fcc_file_ext
	   fcc_outfile_ds = 'CSDR$FIRAS_OUT:FCF_DSK_' // fcc_scan_mode // '.' //
     .			     fcc_file_ext
	   fcc_outfile_cs = 'CSDR$FIRAS_OUT:FCF_SKY_' // fcc_scan_mode // '.'//
     .			     fcc_file_ext
...
C
     ...
     .		 useropen=csa_open_skymap)
	   ...
	   if (io_stat .ne. 0) then
 	      status = %loc(fcf_csaifgopen)
	      call lib$signal (fcf_csaifgopen, %val(2), fcc_infile(1:fcc_inlen),
     .					       %val(io_stat))
	   endif
