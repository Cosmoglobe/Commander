	Program FRD_Extract_Model

c-------------------------------------------------------------------------------
c
c	FRD_EXTRACT_MODEL
c
c	The program FRD_Extract_Model reads Dale Fixsen's Firas calibration
...
c	version of Dale Fixsen's program that generated the solution and
c	XXXXXXXXXX is the label of the solution.  The binary file can then be
C	CCL'ed into the Firas Calibration Reference Archive.
c
c	Author:   Gene Eplee
...
c-------------------------------------------------------------------------------
	...
	integer * 4	frd_parse_model
	integer * 4	frd_read_model
	integer * 4	frd_write_model
