	integer * 4 function  frd_write_model ()

c-------------------------------------------------------------------------------
c
c	Function FRD_WRITE_MODEL
c
...
c	Fixsen's program that generated the solution, and XXXXXXXXXX is the
