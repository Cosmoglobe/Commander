	integer * 4 function  frd_parse_model ()

c-------------------------------------------------------------------------------
c
c	Function FRD_PARSE_MODEL
c
c	This function parses the command line for the program FRD_EXTRACT_MODEL.
c	This parse determines the channel and scan mode for which 
c	FRD_EXTRACT_MODEL is to be run, the file extension of the model
