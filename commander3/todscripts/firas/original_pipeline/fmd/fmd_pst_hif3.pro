...
;  FMD_PST_HIF3 creates and saves the binary records of HIGH_3 stripe arrays
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_PST_HIF3 : Called Incorrectly : FMD_PST_HIF3,error'
 print,' '
 return
endif
;
...
; Stripe Description
; ------------------
descrip = ['DIRBE_BAND_10','DIRBE_BAND_9','TIME_1']
descrip = $
 [descrip,'LHSS_DIHEDRAL','LHSS_BOLOMETER','LHSS_6K_HORN','LHSS_MISSION']
descrip = $
 [descrip,'RHSS_DIHEDRAL','RHSS_BOLOMETER','RHSS_6K_HORN','RHSS_MISSION']
descrip = $
 [descrip,'LHFA_DIHEDRAL','LHFA_BOLOMETER','LHFA_6K_HORN','LHFA_MISSION']
descrip = $
 [descrip,'RHFA_DIHEDRAL','RHFA_BOLOMETER','RHFA_6K_HORN','RHFA_MISSION']
;
...
IF (nrec NE N_ELEMENTS(descrip)) THEN BEGIN
 PRINT,'FMD_PST_HIF3 : Error in Number of Records !'
 RETURN
ENDIF
;
...
; -------------------------
sky_wgts_ds=0 & chi2_hi3ch=0 & diag=0 & omega=0 & square=0
...
f_hi3=0 & c_high_3=0 & ndf_ejg_high_3=0
;
