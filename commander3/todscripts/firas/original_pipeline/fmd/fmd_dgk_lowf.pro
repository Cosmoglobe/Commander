...
;  FMD_DGK_LOWF creates and saves the binary records of LOWF coadd DIRBE
;               gradient kernals.
;
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_DGK_LOWF : Called Incorrectly : FMD_DGK_LOWF,error'
 print,' '
 return
endif
;
...
;
PRINT,'Restoring FMD_DIRBE_FUNC_LOWF.ISS'
PRINT,' '
...
f8=0 & f9=0 & f10=0
f_lo=0 & c_lowf=0 & ejg_lowf=0 & ndf_ejg_lowf=0 & gamma_lowf=0 & chi2_loch=0
;
