...
;  FMD_SKY_HIF2 creates and saves the binary records of destriped calibrated
;               HIGH_2 sky spectra .
;
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_SKY_HIF2 : Called Incorrectly : FMD_SKY_HIF2,error'
 print,' '
 return
endif
;
...
FOR i=0,nrec-1 DO BEGIN
 ...
 sky_rec(i).spectrum(0:nf-1) = FLOAT(s_high_2(xpi,ypi,*))
ENDFOR
;
...
; -------------------------
chanscan=0 & stripes_descrip=0 & pcvr=0 & rect=0 & beta=0 & c_high_2=0
nc_high=0 & chi2_high_2=0 & z_high_2=0
;
