Pro FMD_Bad2_LHF,badcoadd_lhf,badcal_lhf,error
;

if N_Params() ne 3 then begin
 print,'FMD_Bad2_LHF,badcoadd_lhf,badcal_lhf,error'
 error = 1
 return
endif
;
