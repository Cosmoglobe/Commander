Pro FMD_DIRBE_FUNC,idd
;

if N_Params() ne 1 then begin
 print,'FMD_DIRBE_FUNC,idd'
 return
endif
;

RESTORE,'csdr$firas_ref:' + idd + '_weights.iss'
;
...
sname = 'csdr$firas_ref:fmd_dirbe_func_' + idd + '.iss'
...
model_var=0 & tm_up=0 & tm_dn=0 & gpow=0 & bpow=0 & nscan=0 & delt=0
latcut=0 & loncut=0 & tmcut=0 & lp_orderv=0 & solution=0 & freq_band=0
fsl_idx=0 & sky_lbl=0
;
