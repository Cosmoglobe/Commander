...
;  FMD_COV_HIF4 creates and saves the binary records of HIGH_4 C-Matrix .
;
;  Written by :  Ken Jensen, Hughes STX, 23-May-1997
;-
;______________________________________________________________________________
;
Pro FMD_COV_HIF4,error
;
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_COV_HIF4 : Called Incorrectly : FMD_COV_HIF4,error'
 print,' '
 return
endif
;
...
FOR i=0,nrec-1 DO BEGIN
 cov_rec(i).row_num = i
 cov_rec(i).row_covr(0:nrec-1) = covar_high_4(i,*)
ENDFOR
;
