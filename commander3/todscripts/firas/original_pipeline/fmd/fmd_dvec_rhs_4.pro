Pro FMD_DVEC_RHS_4,error
;

;
;  FMD_DVEC_RHS_4 drives the FMD_DVECTOR procedure to compute
;  the RHSS Band_4 D-Vector .
;
;
;  ARGUMENTS (I/O)    :
;
...
;
;    CSDR$FIRAS_OUT   =  Directory containing RHS_4_CVECTOR.ISS and RHS_4_EJG.ISS,
;                        where output RHS_4_DVECTOR.ISS will be sent.
;
;
;    EXAMPLE : $ uidl
;              UIDL> FMD_DVEC_RHS_4,error
;
;
;    HISTORY : Written by Ken Jensen, Hughes STX, 19-Jun-97.
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
;; BEGIN
...
IF N_Params() ne 1 THEN BEGIN 
 PRINT,'FMD_DVEC_RHS_4 : Incorrect invocation !'
 PRINT,' '
 PRINT,'Correct invocation is :'
 PRINT,' '
 PRINT,'IDL> FMD_DVEC_RHS_4,error'
 PRINT,' '
 PRINT,'Returning with Error.'
 PRINT,' '
 PRINT,'Try again with valid invocation.'
 PRINT,' '
 PRINT,'Example : IDL> FMD_DVEC_RHS_4,error'
 PRINT,' '
 RETURN
ENDIF
;
...
; ----------------
PRINT,' '
PRINT,'Restoring ' + outtrans(0) + 'RHS_4_CVECTOR.ISS'
...
IF (cf NE N_ELEMENTS(freq_rhs_4)) THEN BEGIN
 PRINT,''
 PRINT,'FMD_DVEC_RHS_4 : Error in Frequency Array !'
 PRINT,''
 RETURN
ENDIF
;
...
dvec_rhs_4 = $
 FMD_DVECTOR(var=var,mask=mask,nifgs=nifgs,st_sub=st_sub,sky_wgts=sky_wgts_ds,$
             good=good_dvec_rhs_4,ndf_dvec=ndf_dvec_rhs_4)
;

; Make RHS_4_DVECTOR.ISS Save Set
; -------------------------------
chanscan = 'RHS_4'
freq_dependence = 'N'
dvec_cut = cvec_cut
sname = 'csdr$firas_out:rhs_4_dvector.iss'
SAVE,filename=sname,chanscan,freq_dependence,dvec_cut,max_frac,freq_rhs_4,$
                    dvec_rhs_4,good_dvec_rhs_4,ndf_dvec_rhs_4
PRINT,' '
PRINT,'IDL Save Set "'+outtrans(0)+'RHS_4_DVECTOR.ISS" Created.'
PRINT,' '
;
...
n_rhs=0 & b_rhs=0 & l_rhs=0 & d_rhs=0 & f_hi4=0
cvec_rhs_4=0 & ndf_cvec_rhs_4=0 & galcut_rhs=0 & cal_var_rhs=0
;
