...
;  FMD_SKY_HIGH creates and saves the binary records of destriped calibrated
;               HIGH sky spectra .
;
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_SKY_HIGH : Called Incorrectly : FMD_SKY_HIGH,error'
 print,' '
 return
endif
;
...
FOR i=0,nrec-1 DO BEGIN
 ...
 sky_rec(i).spectrum(0:nf-1) = FLOAT(s_high(xpi,ypi,*))
ENDFOR
;
