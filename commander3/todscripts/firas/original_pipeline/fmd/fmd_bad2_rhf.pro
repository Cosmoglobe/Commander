Pro FMD_Bad2_RHF,badcoadd_rhf,badcal_rhf,error
;

if N_Params() ne 3 then begin
 print,'FMD_Bad2_RHF,badcoadd_rhf,badcal_rhf,error'
 error = 1
 return
endif
;
...
IF (MAX(badcoadd_old) GE 0) THEN BEGIN
 ...
 IF (dummy NE 0.) THEN BEGIN
  PRINT,'FMD_BAD2_RHF : Error in SKY_CHI2 Weights !'
  RETURN
 ENDIF
ENDIF
;
...
IF (MAX(badcal_old) GE 0) THEN BEGIN
 ...
 IF (dummy NE 0.) THEN BEGIN
  PRINT,'FMD_BAD2_RHF : Error in CAL_CHI2 Weights !'
  RETURN
 ENDIF
ENDIF
;
