...
;  FMD_OST_HRES creates and saves the binary records of HRES stripe arrays
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_OST_HRES : Called Incorrectly : FMD_OST_HRES,error'
 print,' '
 return
endif
;
...
FOR i=0,nrec-1 DO BEGIN
 ost_rec(i).str_gama(0:nf-1) = gamma_hres(*,i)
...
; -------------------------
sky_wgts_ds=0 & chi2_hrch=0 & pcvr=0 & rect=0 & diag=0 & omega=0 & square=0
...
f_hr=0 & c_hres=0 & ejg_hres=0 & ndf_ejg_hres=0
;
