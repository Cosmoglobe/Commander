...
;  FMD_PST_HIF2 creates and saves the binary records of HIGH_2 stripe arrays
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_PST_HIF2 : Called Incorrectly : FMD_PST_HIF2,error'
 print,' '
 return
endif
;
...
descrip = [descrip,'LHSS_DIHEDRAL','LHSS_6K_HORN','LHSS_MISSION']
descrip = [descrip,'RHSS_DIHEDRAL','RHSS_6K_HORN','RHSS_MISSION']
descrip = [descrip,'LHFA_DIHEDRAL','LHFA_6K_HORN','LHFA_MISSION']
descrip = [descrip,'RHFA_DIHEDRAL','RHFA_6K_HORN','RHFA_MISSION']
;
...
IF (nrec NE N_ELEMENTS(descrip)) THEN BEGIN
 PRINT,'FMD_PST_HIF2 : Error in Number of Records !'
 RETURN
ENDIF
;
...
FOR i=0,nrec-1 DO BEGIN
 ...
 pst_rec(i).str_spec(0:nf-1) = FLOAT(ejg_high_2(*,i))
...
; -------------------------
sky_wgts_ds=0 & chi2_hi2ch=0 & diag=0 & omega=0 & square=0
...
f_hi2=0 & c_high_2=0 & ndf_ejg_high_2=0
;
