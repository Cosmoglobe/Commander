...
;  FMD_DGK_HIGH creates and saves the binary records of HIGH coadd DIRBE
;               gradient kernals.
;
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_DGK_HIGH : Called Incorrectly : FMD_DGK_HIGH,error'
 print,' '
 return
endif
;
...
;
PRINT,'Restoring FMD_DIRBE_FUNC_HIGH.ISS'
PRINT,' '
...
cvec_mask=0 & chanscan=0 & chan_label=0 & stripes_descrip=0 & chi2_hi2ch=0
