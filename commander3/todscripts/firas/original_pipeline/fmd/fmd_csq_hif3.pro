...
;  FMD_CSQ_HIF3 creates and saves the binary records of HIGH_3 pixel chi-squared.
;
;  Written by :  Ken Jensen,  Hughes STX,  03-Jun-1997
;-
;______________________________________________________________________________
;
Pro FMD_CSQ_HIF3,error
;
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_CSQ_HIF3 : Called Incorrectly : FMD_CSQ_HIF3,error'
 print,' '
 return
endif
;
...
FOR i=0,nrec-1 DO BEGIN
 ...
 csq_rec(i).comb_csq = FLOAT(chi2_high_3(xpi,ypi))
ENDFOR
;
...
c_high_3=0 & s_high_3=0 & z_high_3=0 & stripe_contrib=0
;
