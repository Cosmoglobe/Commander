...
;
;  FMD_DIRBE_FUNCL Makes the FMD_DIRBE_FUNC_LOWF Reference Data Set
;
;
;  Required Logicals :
;
;     CSDR$FIRAS_IN  : Directory containing LOWF.ISS and LOWF_WEIGHTS.ISS.
;
;     CSDR$FIRAS_REF : Directory containing FMD_DIRBE_FUNC0_LOWF.ISS, and
;                      where FMD_DIRBE_FUNC_LOWF.ISS will be sent.
;
;
...
;
RESTORE,'csdr$firas_ref:fmd_dirbe_func0_lowf.iss'
;
...
idd = 'LOWF'
sname = 'csdr$firas_ref:fmd_dirbe_func_lowf.iss'
...
st_sub=0 & cal_nifgs=0 & freq_lowf=0 & scale_factor=0 & solution=0
