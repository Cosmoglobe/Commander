Pro FMD_Bad2_LHS,badcoadd_lhs,badcal_lhs,error
;

if N_Params() ne 3 then begin
 print,'FMD_Bad2_LHS,badcoadd_lhs,badcal_lhs,error'
 error = 1
 return
endif
;
...
IF (MAX(badcoadd_old) GE 0) THEN BEGIN
 ...
 IF (dummy NE 0.) THEN BEGIN
  PRINT,'FMD_BAD2_LHS : Error in SKY_CHI2 Weights !'
  RETURN
 ENDIF
ENDIF
;
...
IF (MAX(badcal_old) GE 0) THEN BEGIN
 ...
 IF (dummy NE 0.) THEN BEGIN
  PRINT,'FMD_BAD2_LHS : Error in CAL_CHI2 Weights !'
  RETURN
 ENDIF
ENDIF
;
