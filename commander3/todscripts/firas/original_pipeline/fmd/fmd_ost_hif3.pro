...
;  FMD_OST_HIF3 creates and saves the binary records of HIGH_3 stripe arrays
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_OST_HIF3 : Called Incorrectly : FMD_OST_HIF3,error'
 print,' '
 return
endif
;
...
FOR i=0,nrec-1 DO BEGIN
 ost_rec(i).str_gama(0:nf-1) = gamma_high_3(*,i)
...
; -------------------------
sky_wgts_ds=0 & chi2_hi3ch=0 & pcvr=0 & rect=0 & diag=0 & omega=0 & square=0
...
f_hi3=0 & c_high_3=0 & ejg_high_3=0 & ndf_ejg_high_3=0
;
