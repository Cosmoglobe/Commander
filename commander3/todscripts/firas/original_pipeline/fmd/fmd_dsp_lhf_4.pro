Pro FMD_DSP_LHF_4,error
;

;
;  FMD_DSP_LHF_4 drives the FMD_APPLY procedure to apply destriper
...
;
;    CSDR$FIRAS_OUT   =  Directory containing LHF_4_EJG.ISS and LHF_4_FUNC.ISS,
;                        and where LHF_4_DSP.ISS will be sent.
;
;
;
;    EXAMPLE : $ uidl
;              UIDL> FMD_DSP_LHF_4,error
;
;
...
IF N_Params() ne 1 THEN BEGIN
 PRINT,'FMD_DSP_LHF_4 : Incorrect invocation !'
 PRINT,' '
 PRINT,'Correct invocation is :'
 PRINT,' '
 PRINT,'IDL> FMD_DSP_LHF_4,error'
 PRINT,' '
...
IF (cf ne N_ELEMENTS(f_hi4)) THEN BEGIN
 PRINT,''
 PRINT,'FMD_DSP_LHF_4 : Error in Frequency Array !'
 PRINT,''
 RETURN
ENDIF
;
...
; -----------------
chanscan = 'LHF_4'
sname = 'csdr$firas_out:lhf_4_dsp.iss'
SAVE,filename=sname,chanscan,stripes_descrip,f_hi4,dsp,cal_dsp
PRINT,' '
PRINT,'IDL Save Set "'+outtrans(0)+'LHF_4_DSP.ISS" Created.'
PRINT,' '
;
