...
;  FMD_COV_HRES creates and saves the binary records of HRES C-Matrix .
;
;  Written by :  Ken Jensen, Hughes STX, 23-May-1997
;-
;______________________________________________________________________________
;
Pro FMD_COV_HRES,error
;
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_COV_HRES : Called Incorrectly : FMD_COV_HRES,error'
 print,' '
 return
endif
;
...
FOR i=0,nrec-1 DO BEGIN
 cov_rec(i).row_num = i
 cov_rec(i).row_covr(0:nrec-1) = covar_hres(i,*)
ENDFOR
;
