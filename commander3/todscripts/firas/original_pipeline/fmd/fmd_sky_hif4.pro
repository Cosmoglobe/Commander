...
;  FMD_SKY_HIF4 creates and saves the binary records of destriped calibrated
;               HIGH_4 sky spectra .
;
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_SKY_HIF4 : Called Incorrectly : FMD_SKY_HIF4,error'
 print,' '
 return
endif
;
...
; Restore the saveset
; -------------------
PRINT,'Restoring HIGH_4_SKYMAP.ISS'
PRINT,' '
...
FOR i=0,nrec-1 DO BEGIN
 ...
 sky_rec(i).spectrum(0:nf-1) = FLOAT(s_high_4(xpi,ypi,*))
ENDFOR
;
...
; -------------------------
chanscan=0 & stripes_descrip=0 & pcvr=0 & rect=0 & beta=0 & c_high_4=0
nc_high=0 & chi2_high_4=0 & z_high_4=0
;
