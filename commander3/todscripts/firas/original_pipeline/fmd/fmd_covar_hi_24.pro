Pro FMD_COVAR_HI_24,error
;

;
;  FMD_COVAR_HI_24 drives the FMD_COVAR procedure to create an IDL
;  save set of combined high-channel Band_2/Band_4 covariance.
;
;
;  ARGUMENTS (I/O)    :
;
...
;                        HIGH_24_COVAR.ISS will be sent.
;
;
...
IF N_Params() ne 1 THEN BEGIN 
 PRINT,'FMD_COVAR_HI_24 : Incorrect invocation !'
 PRINT,' '
 PRINT,'Correct invocation is :'
 PRINT,' '
 PRINT,'IDL> FMD_COVAR_HI_24,error'
 PRINT,' '
...
nfreq = [N_ELEMENTS(freq_high_2),N_ELEMENTS(freq_high_4)]
;
...
error =  FMD_COVAR_OFF(nfreq=nfreq,resid1=resid1,resid2=resid2,$
                       ...
                       covar=covar_high_24,ndf_covar=ndf_covar_hi_24)
;

IF (error NE 0) THEN BEGIN
 PRINT,'FMD_COVAR_HI_24 : Error Returned from FMD_COVAR_OFF !'
 RETURN
ENDIF
;
...
freq_dependence = 'N'
n_stripes = nst
sname = 'csdr$firas_out:high_24_covar.iss'
SAVE,filename=sname,chanscan,freq_dependence,cvec_cut,n_stripes,max_frac,$
                    freq_high_2,freq_high_4,covar_high_24,ndf_covar_hi_24
;
PRINT,' '
PRINT,'IDL Save Set "'+outtrans(0)+'HIGH_24_COVAR.ISS" Created.'
PRINT,' '
;
...
freq_high=0 & sp_high_2=0 & z_high_2=0 & sp_high_4=0 & z_high_4=0
;
