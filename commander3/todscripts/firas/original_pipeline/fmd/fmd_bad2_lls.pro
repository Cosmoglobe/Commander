Pro FMD_Bad2_LLS,badcoadd_lls,badcal_lls,error
;

if N_Params() ne 3 then begin
 print,'FMD_Bad2_LLS,badcoadd_lls,badcal_lls,error'
 error = 1
 return
endif
;
...
IF (dummy NE 0.) THEN BEGIN
 PRINT,'FMD_BAD2_LLS : Error in SKY_CHI2 Weights !'
 RETURN
ENDIF
;
...
IF (MAX(badcal_old) GE 0) THEN BEGIN
 ...
 IF (dummy NE 0.) THEN BEGIN
  PRINT,'FMD_BAD2_LLS : Error in CAL_CHI2 Weights !'
  RETURN
 ENDIF
ENDIF
;
