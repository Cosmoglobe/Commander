...
;  FMD_OST_HIF4 creates and saves the binary records of HIGH_4 stripe arrays
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_OST_HIF4 : Called Incorrectly : FMD_OST_HIF4,error'
 print,' '
 return
endif
;
...
FOR i=0,nrec-1 DO BEGIN
 ost_rec(i).str_gama(0:nf-1) = gamma_high_4(*,i)
...
; -------------------------
sky_wgts_ds=0 & chi2_hi4ch=0 & pcvr=0 & rect=0 & diag=0 & omega=0 & square=0
...
f_hi4=0 & c_high_4=0 & ejg_high_4=0 & ndf_ejg_high_4=0
;
