Pro FMD_DSP_LHS_2,error
;

;
;  FMD_DSP_LHS_2 drives the FMD_APPLY procedure to apply destriper
...
;
;    CSDR$FIRAS_OUT   =  Directory containing LHS_2_EJG.ISS and LHS_2_FUNC.ISS,
;                        and where LHS_2_DSP.ISS will be sent.
;
;
;
;    EXAMPLE : $ uidl
;              UIDL> FMD_DSP_LHS_2,error
;
;
...
IF N_Params() ne 1 THEN BEGIN
 PRINT,'FMD_DSP_LHS_2 : Incorrect invocation !'
 PRINT,' '
 PRINT,'Correct invocation is :'
 PRINT,' '
 PRINT,'IDL> FMD_DSP_LHS_2,error'
 PRINT,' '
...
IF (cf ne N_ELEMENTS(f_hi2)) THEN BEGIN
 PRINT,''
 PRINT,'FMD_DSP_LHS_2 : Error in Frequency Array !'
 PRINT,''
 RETURN
ENDIF
;
...
; -----------------
chanscan = 'LHS_2'
sname = 'csdr$firas_out:lhs_2_dsp.iss'
SAVE,filename=sname,chanscan,stripes_descrip,f_hi2,dsp,cal_dsp
PRINT,' '
PRINT,'IDL Save Set "'+outtrans(0)+'LHS_2_DSP.ISS" Created.'
PRINT,' '
;
