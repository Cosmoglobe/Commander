...
;  FMD_AVC_HIF3 creates and saves the binary records of HIGH_3 A-Vector .
;
;-
;______________________________________________________________________________
;
Pro FMD_AVC_HIF3,error
;
...
if N_Params() ne 1 then begin
 print,' '
 print,'FMD_AVC_HIF3 : Called Incorrectly : FMD_AVC_HIF3,error'
 print,' '
 return
endif
;
...
; Restore the saveset
; -------------------
PRINT,'Restoring HIGH_3_AVECTOR.ISS'
PRINT,' '
RESTORE,'csdr$firas_out:high_3_avector.iss'
;
...
PRINT,' '
avc_rec.a_vector(0:31) = FLOAT(avec_high_3(0:31))
;
...
PRINT,' '
outfile = 'csdr$firas_out:fmd_avc_hif3.pass4'
rec_len = 128            ; fixed length record size in bytes
OPENW,1,outfile, rec_len, /fixed
WRITEU,1,avc_rec(0)
CLOSE,1
;
fname = STRUPCASE(outtrans(0)) + ':FMD_AVC_HIF3.PASS4'
...
freq_high_3=0 & delta_freq_hi_3=0
;
