...
;
;  FMD_DIRBE_FUNCH Makes the FMD_DIRBE_FUNC_HIGH Reference Data Set
;
;
;  Required Logicals :
;
;     CSDR$FIRAS_IN  : Directory containing HIGH.ISS and HIGH_WEIGHTS.ISS.
;
;     CSDR$FIRAS_REF : Directory containing FMD_DIRBE_FUNC0_HIGH.ISS, and
;                      where FMD_DIRBE_FUNC_HIGH.ISS will be sent.
;
;
...
;
RESTORE,'csdr$firas_ref:fmd_dirbe_func0_high.iss'
;
...
idd = 'HIGH'
sname = 'csdr$firas_ref:fmd_dirbe_func_high.iss'
...
cal_nifgs=0 & freq_high=0 & scale_factor=0 & solution=0
