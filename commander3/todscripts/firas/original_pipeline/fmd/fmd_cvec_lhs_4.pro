Pro FMD_CVEC_LHS_4,error
;

;
;  FMD_CVEC_LHS_4 drives the FMD_CVECTOR procedure to compute
;  the Band_4 LHSS C-Vector .
;
;
;  ARGUMENTS (I/O)    :
;
...
;                        LHS_4_DVECTOR.ISS, and LHS_4_EJG.ISS, and where
;                        LHS_4_CVECTOR_2.ISS will be sent .
;
;
;    EXAMPLE : $ uidl
;              UIDL> FMD_CVEC_LHS_4,error
;
;
...
IF N_Params() ne 1 THEN BEGIN 
 PRINT,'FMD_CVEC_LHS_4 : Incorrect invocation !'
 PRINT,' '
 PRINT,'Correct invocation is :'
 PRINT,' '
 PRINT,'IDL> FMD_CVEC_LHS_4,error'
 PRINT,' '
 PRINT,'Returning with Error.'
 PRINT,' '
 PRINT,'Try again with valid invocation.'
 PRINT,' '
 PRINT,'Example : IDL> FMD_CVEC_LHS_4,error'
 PRINT,' '
 RETURN
ENDIF
;
...
IF (cf NE N_ELEMENTS(f_hi4)) THEN BEGIN
 PRINT,''
 PRINT,'FMD_CVEC_LHS_4 : Error in Frequency Array !'
 PRINT,''
 RETURN
ENDIF
freq = f_hi4(nf)
...
; ----------------
PRINT,' '
PRINT,'Restoring ' + outtrans(0) + 'LHS_4_DVECTOR.ISS'
RESTORE,'csdr$firas_out:lhs_4_dvector.iss'
;
...
cvec_lhs_4 = $
 FMD_CVECTOR(pixel=px,spec=dsp,sky_wgts_ds=sky_wgts_ds,w_frac=frac_wgt,$
             ...
             max_frac=max_frac,good_dvec=good_dvec_lhs_4,$
             ndf_cvec=ndf_cvec_lhs_4,good_cvec=good_cvec_lhs_4)
;

; Make LHS_4_CVECTOR_2.ISS Save Set
; ---------------------------------
chanscan = 'LHS_4'
freq_dependence = 'N'
freq_lhs_4 = f_hi4
sname = 'csdr$firas_out:lhs_4_cvector_2.iss'
SAVE,filename=sname,chanscan,stripes_descrip,freq_dependence,cvec_cut,$
                    freq_lhs_4,cvec_lhs_4,ndf_cvec_lhs_4,good_cvec_lhs_4
PRINT,' '
PRINT,'IDL Save Set "'+outtrans(0)+'LHS_4_CVECTOR_2.ISS" Created.'
PRINT,' '
;
...
n_lhs=0 & b_lhs=0 & l_lhs=0 & d_lhs=0 & dvec_lhs_4=0 & ndf_dvec_lhs_4=0
zodi_array=0 & solution=0 & f=0 & galcut=0 & cal_lbl=0 & sky_lbl=0 & scan=0
time=0 & model_var=0 & lp_orderv=0
tm_up=0 & tm_dn=0 & gpow=0 & bpow=0 & nscan=0 & delt=0 & tmcut=0
;
