...
;
;DESCRIPTION:  
;     A driver to process FEF Alternative_2
;     ( 4 Mission Periods, 2 UFO with TAU = [61.,153.] )
;
;CALLING SEQUENCE:  
...
; Mission Periods
; ---------------
step_up1 = ['89328','901391535','901931850','902081120']
step_dn1 = ['901391535','901931850','902081120','9026409']
;
if((chanscan eq 'RLLF')or(chanscan eq 'LLLF'))then begin
 step_up1 = ['89328','901391535','902081120']
 step_dn1 = ['901391535','901931850','9026409']
endif
;
...
; FEF IDL Save Set
; ----------------
sname='csdr$firas_save:'+idd+'_fef_2.iss'
