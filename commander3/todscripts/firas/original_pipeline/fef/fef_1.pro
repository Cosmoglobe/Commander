...
;
;DESCRIPTION:  
;     A driver to process FEF Alternative_1
;     ( 4 Mission Periods, 1 UFO with TAU = [55.] )
;
;CALLING SEQUENCE:  
...
; FEF IDL Save Set
; ----------------
sname='csdr$firas_save:'+idd+'_fef_1.iss'
