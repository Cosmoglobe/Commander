...
;
;DESCRIPTION:  
;     A driver to process FEF Alternative_3 ( 3 Mission Periods, 2 UFO ).
;     There are two sets of [TAU_1,TAU_2], determined from points on
;     the 95.4% confidence contour of Delta_Chi_Squared.
;
;CALLING SEQUENCE:  
...
;
;   CSDR$FIRAS_ERRORS must contain the PEP_ERRORS.xxxx files. To use
...
;   ('y' identifies the destriping model, e.g. '50_140_3MP' )
;
;EXAMPLE:
;   $ UPRIDL
;   chanscan='LLSS'
;   FEF_3,chanscan,error
;
;#
;COMMON BLOCKS:
;   None
...
; FEF IDL Save Set
; ----------------
sname='csdr$firas_save:'+idd+'_fef_3a.iss'
...
; FEF IDL Save Set
; ----------------
sname='csdr$firas_save:'+idd+'_fef_3b.iss'
save,filename=sname,idd,tau1,step_up1,step_dn1,f,diff,d_unc,ratio,r_unc
;
