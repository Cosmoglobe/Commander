      integer*4 function fcc_parse(channel,scan_mode,cov_ext,mod_ext,bol_avg,
...
c             scan_mode     i*4    Value of scan mode, 1-4=SS-LF (3 excluded).
...
c
      ...
      fcc_parse = %loc(fcc_normal)
c
c     Parse channel qualifier.
c
      command_line(1)(1:12) = 'FCC/CHANNEL='
