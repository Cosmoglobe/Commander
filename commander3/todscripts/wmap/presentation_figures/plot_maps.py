...
wmap_K = hp.read_map('/mn/stornext/d16/cmbco/ola/wmap/freq_maps/wmap_iqusmap_r9_9yr_Q1_v5.fits',
    field=(0,1,2))

transparent = False


comm_K = hp.read_map('/mn/stornext/d16/cmbco/bp/dwatts/WMAP/chains_noise_test/tod_040-WMAP_Q1_map_c0001_k000010.fits', field=(0,1,2))
