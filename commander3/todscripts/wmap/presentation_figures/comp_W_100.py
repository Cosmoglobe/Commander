...
try:
   ...
   d_100 = hp.read_map('/mn/stornext/d16/cmbco/ola/npipe/freqmaps/npipe6v20_100_map_K.fits', field=(0,1,2))
...
d_W = (d_W1[:3]/d_W1[3:]**2 + d_W2[:3]/d_W2[3:]**2 + d_W3[:3]/d_W3[3:]**2 + d_W4[:3]/d_W4[3:]**2)/(1/d_W1[3:]**2 + 1/d_W2[3:]**2 + 1/d_W3[3:]**2 + 1/d_W4[3:]**2)
