...
d_DR4_044 = (
    hp.read_map(
        "/mn/stornext/d16/cmbco/ola/npipe/freqmaps/npipe6v20_044_map_K.fits",
        field=(0, 1, 2),
    )
    * 1e6
)
d_BP_044 = hp.read_map(
    "/mn/stornext/d16/cmbco/bp/delivery/v10.00/v2/BP_044_IQU_n0512_v2.fits",
    field=(0, 1, 2),
)
...
d_Q1_CG = (
    hp.read_map(
        "/mn/stornext/d16/www_cmb/dwatts/v0/BP_040-WMAP_Q1_IQU_n0512_v0.fits",
        field=(0, 1, 2),
    )
    * 1e3
)
...
cosmoglobe.plot(d_DR4_044 - d_Q1_orig * 0.78, min=-10, max=10, sig=1)
cosmoglobe.plot(d_BP_044 - d_Q1_orig * 0.78, min=-10, max=10, sig=1)
