...
for i in range(len(fnames)):
  ...
  hp.gnomview(slAB, rot=(90,-19.5, 0), reso=5, min=-0.5,
      max=0.5, cmap='coolwarm')
plt.close('all')
plt.show()
...
hp.gnomview(slA+m_rotated, rot=(90,-19.5, 0), reso=10, min=-0.5,
    max=0.5, cmap='coolwarm')
hp.graticule()
hp.gnomview(m_rotated, rot=(90,-19.5, 0), reso=10, min=-0.5,
    max=0.5, cmap='coolwarm')
hp.graticule()
