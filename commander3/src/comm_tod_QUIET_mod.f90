module comm_tod_QUIET_mod
  ...
  interface
    module subroutine process_QUIET_tod(self, chaindir, chain, iter, handle, map_in, delta, map_out, rms_out)
      !
...
contains
  ...
  !  constructor%ndiode          = 4 ! number of diodes in an amplifier
