...
module comm_tod_noise_psd_mod
  ...
  private
  public comm_noise_psd, comm_noise_psd_white, comm_noise_psd_oof, comm_noise_psd_2oof, comm_noise_psd_oof_gauss, comm_noise_psd_oof_quad, comm_noise_psd_spline ! MODIFIED
