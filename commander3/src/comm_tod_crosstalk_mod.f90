...
module comm_tod_crosstalk_mod
  ...
  type :: comm_crosstalk
    real(sp), dimension (:,:), allocatable      :: crosstalk_matrix  ! HKE: Perhaps this should actually be turned into a sparse matrix
  contains
...
contains
  ...
  ! Duncan: Must be rewritten to only use single-precision TOD array data, not comm_scandata
