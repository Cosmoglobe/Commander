...
!
!    subroutine input_map_s
!    subroutine read_bintab_s
!    subroutine read_conbintab_s
!    subroutine write_bintab_s
!    subroutine write_asctab_s
!    subroutine dump_alms_s
!    subroutine write_alms_s
!    subroutine read_alms_s
!    subroutine read_bintod_s
!    subroutine write_bintabh_s
!
!
...
! K L O A D : suffixe of routine name, to be replaced by either s (SP) or d (DP)
  !=======================================================================
  subroutine input_map_s(filename, map, npixtot, nmaps, fmissval, header, units, extno)
    !=======================================================================
    !     reads fits file
...
!    deallocate(unitsm)
    ...
    RETURN
  END subroutine input_map_s
  !=======================================================================
  subroutine read_bintab_s(filename, map, npixtot, nmaps, nullval, anynull, header, units, extno)
  !=======================================================================
    !     Read a FITS file
...
!     enddo
  ...
  !=======================================================================
  subroutine write_bintab_s(map, npix, nmap, header, nlheader, filename, extno)
    !=======================================================================
