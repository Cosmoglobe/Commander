...
!$OMP end parallel
  ...
  subroutine alm2map_sc_der_s(nsmax, nlmax, nmmax, alm, map, der1, der2)
    ...
    complex(SPC), INTENT(IN),  dimension(1:1,0:nlmax,0:nmmax) :: alm
    real(SP),   INTENT(OUT), dimension(0:12*nsmax**2-1)     :: map
    real(SP),   INTENT(OUT), dimension(0:12*nsmax**2-1,1:2) :: der1
    real(SP),   INTENT(OUT), dimension(0:12*nsmax**2-1,1:3), optional :: der2
...
!$OMP end parallel
  ...
  subroutine alm2map_pol_der_s(nsmax, nlmax, nmmax, alm_TGC, map_TQU, der1, der2)
    ...
    complex(SPC), INTENT(IN),  dimension(1:3,0:nlmax,0:nmmax) :: alm_TGC
    real(SP),   INTENT(OUT), dimension(0:12*nsmax**2-1,1:3)     :: map_TQU
    real(SP),   INTENT(OUT), dimension(0:12*nsmax**2-1,1:6) :: der1
    real(SP),   INTENT(OUT), dimension(0:12*nsmax**2-1,1:9), optional :: der2
