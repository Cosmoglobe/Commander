...
!
  ...
  subroutine mpi_map2alm_dist_KLOAD(map, alms)
    implicit none
  ...
  end subroutine mpi_map2alm_dist_KLOAD


  subroutine mpi_alm2map_dist_KLOAD(alms, map)
    implicit none
  ...
  end subroutine mpi_alm2map_dist_KLOAD


  subroutine mpi_map2alm_dist_slave_KLOAD(map)
    implicit none
  ...
  end subroutine mpi_map2alm_dist_slave_KLOAD


  subroutine mpi_alm2map_dist_slave_KLOAD(map)
    implicit none
  ...
  end subroutine mpi_alm2map_dist_slave_KLOAD
