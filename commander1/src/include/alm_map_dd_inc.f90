...
!$OMP end parallel
  ...
  subroutine alm2map_sc_der_d(nsmax, nlmax, nmmax, alm, map, der1, der2)
    ...
    complex(DPC), INTENT(IN),  dimension(1:1,0:nlmax,0:nmmax) :: alm
    real(DP),   INTENT(OUT), dimension(0:12*nsmax**2-1)     :: map
    real(DP),   INTENT(OUT), dimension(0:12*nsmax**2-1,1:2) :: der1
    real(DP),   INTENT(OUT), dimension(0:12*nsmax**2-1,1:3), optional :: der2
...
!$OMP end parallel
  ...
  subroutine alm2map_pol_der_d(nsmax, nlmax, nmmax, alm_TGC, map_TQU, der1, der2)
    ...
    complex(DPC), INTENT(IN),  dimension(1:3,0:nlmax,0:nmmax) :: alm_TGC
    real(DP),   INTENT(OUT), dimension(0:12*nsmax**2-1,1:3)     :: map_TQU
    real(DP),   INTENT(OUT), dimension(0:12*nsmax**2-1,1:6) :: der1
    real(DP),   INTENT(OUT), dimension(0:12*nsmax**2-1,1:9), optional :: der2
